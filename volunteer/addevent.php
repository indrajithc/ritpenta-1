 ...
 if(isset($_POST['submit-btn'])){
 	...
 	if ($eve_coordinator_1  ==  $eve_coordinator_2) {
 		...
 		if( $result ){
 			$message [0] = 2;
 			$message [1] = ' event name or camp id is already exists'; 
 		} else {
 	...
 	<div class="card-body">
 		...
 		<form  id="addevent"  action="" method="post" class="form-horizontal borderd-row" align="center" data-parsley-validate >
 			...
 			<div class="form-group row">
 				...
 				<div class="col-sm-9">
 					<input  type="name" data-parsley-type="name"  class="form-control" name="event_name" placeholder="Event Name" data-parsley-required="true"  required>
 				</div>
 			</div>
